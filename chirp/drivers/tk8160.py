...
VALID_KEY_SELECTION_7162_TRIANGLE = VALID_KEY_SELECTION_7162 + ['Emergancy']
...
class TK7162Radio(TKx160Radio):
    ...
    def get_settings(self) -> settings.RadioSettings:
        ...
        for desc, name in KEY_NAMES.items():
            ...
            options = (
                VALID_KEY_SELECTION_7162_TRIANGLE if name == "triangle"
        ...
        # General settings
        gen = settings.RadioSettingGroup(
            name='general',
            shortname='General Settings',
        )
        gen.append(
            settings.RadioSetting(
                'tot',
